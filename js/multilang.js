...
var lang = {
    de: {
        ...
        HERO__OPENING_WORD: 'All deine Aufgaben, Projekte und Kontakte',
        HERO__SUBTITLE: 'an einem Ort.',
        HERO__MEET_CHIMP: 'Das ist Chimp.',
        HERO__CTA_BTN: 'Hol dir Chimp für deine Geräte',
        HERO__PRESS_F: 'Drücke <span class="kbd">F</span> um alle Features zu sehen or <b>scrolle runter</b>',
        ...
        MAC_SCREEN__YOUR_CONTACTS: '<span class="bold">Deine</span> <span class="light">Kontakte</span>',
        ...
        CONTACT__OPENING_TEXT: '<span class="light">Hast du Lust Chimp</span> <span class="bold">zu testen?</span>',
        CONTACT__CONTENT_TEXT: '<span class="bold">Chimp kommt diesen Herbst</span> <span class="light">für Mac OS X, und iOS</span> <span class="bold">folgt kurz danach!</span>',
        CONTACT__CONTENT_TEXT_2: '<span class="light">Registriere dich</span> <span class="bold">und gehöre zu den ersten Nutzern!</span>',
    ...
    en: {
        ...
        HERO__PRESS_F: 'Press <span class="kbd">F</span> to see all of our features or <b>scroll down</b>',
        ...
        MAC_SCREEN__YOUR_CONTACTS: '<span class="bold">Your</span><span class="light">Contacts</span>',
        ...
        CONTACT__OPENING_TEXT: '<span class="light">Keen to </span><span class="bold">Try?</span>',
        CONTACT__CONTENT_TEXT: ' <span class="bold">Chimp is rolling out this fall</span><span class="light">to MacOS devices, and iOS devices</span> <span class="bold">soon after!</span>',
        CONTACT__CONTENT_TEXT_2: ' <span class="light">Shoot us your e-mail below</span><span class="bold">and be first to try!</span>',
...
$(".lang_link").on("click",function(){
  ...
  $(".lang_link").css("font-weight", "400")
  $(".lang_link").css("color", "#747374")
...
function toGerman(){
    ...
    //navbar
     ...
     $('[multi_lang="MAC_SCREEN__YOUR_CONTACTS"]').html(lang.de.MAC_SCREEN__YOUR_CONTACTS)
     $('[multi_lang="MAC_SCREEN__SEND_EMAIL"]').html(lang.de.MAC_SCREEN__SEND_EMAIL)
     ...
     //features
     $('[multi_lang="FEATURE_MENU__FEATURES"]').html(lang.de.FEATURE_MENU__FEATURES)
     ...
     $('[multi_lang="CONTACT__CONTENT_TEXT_2"]').html(lang.de.CONTACT__CONTENT_TEXT_2)
...
function toEnglish(){
    ...
    //navbar
     ...
     $('[multi_lang="MAC_SCREEN__YOUR_CONTACTS"]').html(lang.en.MAC_SCREEN__YOUR_CONTACTS)
     $('[multi_lang="MAC_SCREEN__SEND_EMAIL"]').html(lang.en.MAC_SCREEN__SEND_EMAIL)
     ...
     //features
     $('[multi_lang="FEATURE_MENU__FEATURES"]').html(lang.en.FEATURE_MENU__FEATURES)
     ...
     $('[multi_lang="CONTACT__CONTENT_TEXT_2"]').html(lang.en.CONTACT__CONTENT_TEXT_2)
